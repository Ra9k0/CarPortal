        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 7, 22, 19, 44, 38, 99, DateTimeKind.Utc).AddTicks(8621))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("3ba0e94f-d15f-4911-9bd0-e10e9d89397f"), 0, "e8e79cba-b045-4eef-a1cf-75e80309cef6", "ceca@lepa.sr", false, "Ceca", "Lepa", false, null, "CECA@LEPA.SR", "CECA@LEPA.SR", null, null, false, 1, null, false, "ceca@lepa.sr" });
            ...
            migrationBuilder.InsertData(
                table: "Cars",
                columns: new[] { "Id", "ColorId", "ConditionId", "EngineTypeId", "ManufactureYear", "ModelId", "OfferId" },
                values: new object[] { 1, 1, 1, 1, 2021, 1, null });

            migrationBuilder.InsertData(
                table: "Cars",
                columns: new[] { "Id", "ColorId", "ConditionId", "EngineTypeId", "ManufactureYear", "ModelId", "OfferId" },
                values: new object[] { 2, 5, 2, 2, 2006, 6, null });

            migrationBuilder.InsertData(
                table: "Cars",
                columns: new[] { "Id", "ColorId", "ConditionId", "EngineTypeId", "ManufactureYear", "ModelId", "OfferId" },
                values: new object[] { 3, 3, 3, 3, 2000, 3, null });
