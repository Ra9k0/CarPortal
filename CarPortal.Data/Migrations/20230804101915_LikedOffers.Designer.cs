...
namespace CarPortal.Data.Migrations
{
    ...
    [Migration("20230804101915_LikedOffers")]
    partial class LikedOffers
    {
            ...
            modelBuilder.Entity("CarPortal.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "94b79915-5ebe-418b-ba79-db5b405d8873",
                            Email = "ceca@lepa.sr",
            ...
            modelBuilder.Entity("CarPortal.Data.Models.Offer", b =>
                {
                    b.HasOne("CarPortal.Data.Models.Car", "Car")
                        .WithOne("Offer")
                        .HasForeignKey("CarPortal.Data.Models.Offer", "CarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
